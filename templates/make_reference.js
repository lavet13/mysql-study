  ...
  styles: {
    ...
    paragraphStyles: [
      ...
      },
      {
        ...
        basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { font: TNR, size: 28, bold: true, italics: true, color: "000000" },
        paragraph: {
      ...
      // Used for "Рисунок – ..." lines below images
      {
        ...
        basedOn: "Normal",
        run: { font: TNR, size: 24, italics: true, color: "000000" },  // 12pt
        paragraph: {
    ...
    children: [
      new Paragraph({
        children: [new TextRun({
          ...
          font: TNR, size: 24, italics: true, color: "888888",
        })]
      })
    ]
  }]
...
Packer.toBuffer(doc).then(function(buffer) {
  return JSZip.loadAsync(buffer).then(function(zip) {
    return zip.file('word/styles.xml').async('string').then(function(stylesXml) {

      stylesXml = stylesXml.replace('</w:styles>', tableStyleXml + '\n</w:styles>');
