#!/usr/bin/env bash
#
# Builds lab-05/Отчет.docx from lab-05/report.md
# Run from the PROJECT ROOT:
#   bash lab-05/build.sh

set -e

LAB_NUMBER="5"
LAB_TITLE="Строковые и числовые функции"
...
REPORT="lab-05/report.md"
CONTENT_TMP="lab-05/_content_tmp.docx"
OUTPUT="lab-05/Отчет.docx"
