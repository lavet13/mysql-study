...
![Рисунок 4 – Работа и телефон родителей в одном поле](assets/step-04-concat-roditeli.png){ width=80% }
...
![Рисунок 5 – Длина имени, отчества и телефона студента](assets/step-05-length-dannie.png){ width=80% }
...
![Рисунок 6 – Номера телефонов в обратном порядке](assets/step-06-reverse-telephone.png){ width=80% }
...
![Рисунок 7 – Дата рождения повторённая 5 раз](assets/step-07-repeat-date.png){ width=80% }
...
![Рисунок 8 – Замена 1991 на 91 в дате рождения](assets/step-08-replace-date.png){ width=80% }
...
![Рисунок 9 – Количество студентов с серией паспорта 03 01](assets/step-09-position-pasp.png){ width=80% }
...
![Рисунок 10 – Абсолютное значение выражения](assets/step-10-abs.png){ width=80% }
...
![Рисунок 11 – Остаток от деления 16 на 5](assets/step-11-mod.png){ width=80% }
...
![Рисунок 12 – Квадратный корень из 22500](assets/step-12-sqrt.png){ width=80% }
...
![Рисунок 13 – Округление чисел в меньшую и большую сторону](assets/step-13-floor-ceil.png){ width=80% }
