...
![Рисунок 2 – Города Краснодарского края](assets/step-02-subquery-goroda.png){ width=80% }
...
![Рисунок 5 – Преподаватель поставивший оценку Климову по программированию](assets/step-05-subquery-prepod.png){ width=80% }
...
![Рисунок 6 – Специальность студентки Климовой](assets/step-06-subquery-spec.png){ width=80% }
...
![Рисунок 10 – Полный адрес студента Петрова](assets/step-10-subquery-adres.png){ width=80% }
...
![Рисунок 11 – Таблица dannie в Prisma Studio](assets/prisma-tables.png){ width=80% }

phpMyAdmin предоставляет возможность выполнять SQL-запросы напрямую и просматривать результаты в табличном виде.

![Рисунок 12 – Список таблиц базы данных в phpMyAdmin](assets/phpmyadmin-tables.png){ width=80% }

Диаграмма связей в Prisma Studio наглядно показывает отношения между всеми таблицами базы данных `student`.

![Рисунок 13 – Диаграмма связей базы данных в Prisma Studio](assets/prisma-diagram.png){ width=80% }
