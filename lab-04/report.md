...
![Рисунок 1 – Среднее значение оценок по каждому студенту](assets/step-01-avg-student.png){ width=80% }
...
![Рисунок 2 – Максимальная оценка по каждой дисциплине](assets/step-02-max-dischiplina.png){ width=80% }
...
![Рисунок 3 – Средняя оценка каждого преподавателя](assets/step-03-avg-prepod.png){ width=80% }
...
![Рисунок 4 – Минимальная оценка каждого преподавателя](assets/step-04-min-prepod.png){ width=80% }
...
![Рисунок 5 – Перевод оценок в рейтинговые баллы](assets/step-05-rating.png){ width=80% }
...
![Рисунок 8 – Оценки студента с кодом 3](assets/step-08-avg-max-min-student3.png){ width=80% }
...
![Рисунок 9 – Количество хороших оценок](assets/step-09-count-good.png){ width=80% }
...
![Рисунок 10 – Процент двоек по каждому преподавателю](assets/step-10-percent-dvoek.png){ width=80% }
...
![Рисунок 12 – Процент качества и успеваемости](assets/step-12-percent-quality.png){ width=80% }
...
![Рисунок 13 – Улицы с более чем одним студентом](assets/step-13-having-ulica.png){ width=80% }
...
![Рисунок 14 – Оценки удовлетворяющие условию](assets/step-14-condition-count.png){ width=80% }
...
![Рисунок 15 – Таблица uspev в Prisma Studio](assets/prisma-tables.png){ width=80% }

phpMyAdmin предоставляет возможность выполнять SQL-запросы напрямую и просматривать результаты в табличном виде.

![Рисунок 16 – Список таблиц базы данных в phpMyAdmin](assets/phpmyadmin-tables.png){ width=80% }

Диаграмма связей в Prisma Studio наглядно показывает отношения между всеми таблицами базы данных `student`.

![Рисунок 17 – Диаграмма связей базы данных в Prisma Studio](assets/prisma-diagram.png){ width=80% }
